...
class ToastWidget(QFrame):
    ...
    STYLES = {
        ToastType.INFO: {"bg": "#43a047", "border": "#66bb6a", "icon": "ℹ"},
        ToastType.SUCCESS: {"bg": "#43a047", "border": "#66bb6a", "icon": "✓"},
        ToastType.WARNING: {"bg": "#66bb6a", "border": "#81c784", "icon": "⚠"},
        ToastType.ERROR: {"bg": "#7cb342", "border": "#9ccc65", "icon": "✕"},
    }
